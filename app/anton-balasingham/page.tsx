...
export default function AntonBalasinghamPage() {
  const photos = [
    ...
    '7-5.jpg','8-5.jpg','9.jpg','te1-10.jpg','te10.jpg','te11.jpg',
    'te2-4.jpg','te3-5.jpg','te4-2.jpg','te5-3.jpg','te6-1.jpg',
    'te7.jpg','te8.jpg','te9.jpg'
  ]

  const audioFiles = [
    { file: 'Thesathinkural-ninaivil-1.mp3', label: 'Thesathinkural Ninaivil' },
    { file: 'anton-balasingam-patty-balakumar-1.mp3', label: 'Patty Balakumar' },
    { file: 'anton-balasingam-patty-balakumaran-1.mp3', label: 'Patty Balakumaran' },
    { file: 'anton-balasingam-patty-ezhumathi-karikallan-1.mp3', label: 'Patty Ezhumathi Karikallan' },
    { file: 'anton-balasingam-patty-nadesan-karuthu-pakirvu-1.mp3', label: 'Patty Nadesan Karuthu Pakirvu' },
    { file: 'anton-balasingam-patty-soosai-vithusha-1.mp3', label: 'Patty Soosai Vithusha' },
    { file: 'anton-balasingam-patty-sudarmakal-chenchollai-1.mp3', label: 'Patty Sudarmakal Chenchollai' },
    { file: 'anton-balasingam-patty-thamilselvan-1.mp3', label: 'Patty Thamilselvan' },
    { file: 'anton-balasingam-patty-theepa-thalir-kappakam-1.mp3', label: 'Patty Theepa Thalir Kappakam' },
    { file: 'kallakanippu-anton-balasingam-1.mp3', label: 'Kallakanippu' },
    { file: 'kavithai-puthuvai-rathinathurai-for-anton-balasingam-1.mp3', label: 'Kavithai — Puthuvai Rathinathurai' },
  ]
    ...
    <div className="bg-black min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 space-y-16">
        ...
        <div className="flex justify-center">
          <img
            src="/Anton Balasingam/Anton Balasingam.avif"
            alt="Anton Balasingham"
            className="w-56 h-56 object-cover rounded-full border-4 border-red-700"
            onError={(e) => { (e.target as HTMLImageElement).src = '/Anton Balasingam.avif' }}
          />
        </div>
        ...
        <div>
          ...
          <blockquote className="border-l-4 border-yellow-500 bg-zinc-900 p-6 my-6">
        ...
        <div>
          ...
          <blockquote className="border-l-4 border-red-700 bg-zinc-900 p-6 my-6">
        ...
        <div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 p-6">
            <p className="text-gray-400 text-sm mb-2">His complete collection is preserved and accessible at:</p>
        ...
        {/* Photo Gallery */}
        <div>
          <h2 className="text-2xl font-bold text-white mb-6 border-l-4 border-red-700 pl-4">Photo Gallery</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            {photos.map(photo => (
              <img
                key={photo}
                src={`/Anton Balasingam/03_Photos/${photo}`}
                alt="Anton Balasingham"
        ...
        {/* Audio */}
        <div>
          <h2 className="text-2xl font-bold text-white mb-6 border-l-4 border-red-700 pl-4">Audio — About Balasingham</h2>
          <div className="space-y-4">
            {audioFiles.map(({ file, label }) => (
              <div key={file} className="bg-zinc-900 border border-zinc-800 p-4">
                <p className="text-white text-sm font-semibold mb-2">{label}</p>
                <audio controls className="w-full">
                  <source src={`/Anton Balasingam/04_Audio about Balasingam/${file}`} type="audio/mpeg" />
                </audio>
              </div>
            ))}
          </div>
